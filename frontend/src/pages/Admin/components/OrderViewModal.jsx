            ...
            <div class="invoice-body">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="text-align: right;">
                        <div class="amount">Rs. ${order.amount}</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="total-section">
                <div class="total-row">
                  ...
                  <span class="total-value">Rs. ${order.amount}</span>
                </div>
                <div class="total-row">
                ...
                <div class="total-row">
                  ...
                  <span style="color: #059669;">Rs. ${order.amount}</span>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  <tr className="border-t border-richblack-700 bg-richblack-700 bg-opacity-50">
                    ...
                    <td className="p-4 text-right">
                      <p className="font-medium text-yellow-50">Rs. {order.amount}</p>
                    </td>
                  </tr>
                </tbody>
                <tfoot>
                  <tr className="border-t border-richblack-600 bg-richblack-700">
                    ...
                    <td className="p-4 text-right">
                      <p className="text-lg font-bold text-yellow-50">Rs. {order.amount}</p>
                    </td>
                  </tr>
                </tfoot>
              </table>
